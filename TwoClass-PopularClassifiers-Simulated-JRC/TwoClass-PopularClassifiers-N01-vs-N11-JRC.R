...
res.list.N01.vs.N11 <- list("d=5" = res.list[[1]],
                            "d=10" = res.list[[2]],
                            "d=25" = res.list[[3]],
                            "d=50" = res.list[[4]],
                            "d=100" = res.list[[5]],
...
writexl::write_xlsx(x = res.list.N01.vs.N11, 
                    path = "C:\\Users\\JYOTISHKA\\Desktop\\Pop-N01-vs-N11.xlsx")

# writexl::write_xlsx(x = res.list.N01.vs.N11, 
#                     path = "E:\\Jyotishka\\Code\\Pop-N01-vs-N11.xlsx")
