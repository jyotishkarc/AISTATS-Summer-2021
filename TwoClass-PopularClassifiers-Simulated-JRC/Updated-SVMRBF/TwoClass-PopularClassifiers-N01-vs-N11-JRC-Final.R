...
df.N01.vs.N11 <- rio::import_list("~/R/R Codes/Classification of HDLSS Data (Summer, 2021)/HDLSS-Summer-2021/TwoClass-PopularClassifiers-Simulated-JRC/Results/Pop-N01-vs-N11-with-nn.xlsx")
...
for (k in 1:length(d.seq)) {
   ...
   df.N01.vs.N11[[k]]$SVMRBF <- c(result, NA, mean(result), sciplot::se(result))
...
writexl::write_xlsx(x = df.N01.vs.N11,
                    path = "C:\\Users\\JYOTISHKA\\Desktop\\Pop-N01-vs-N11-updated.xlsx")
