...
df.C01.vs.C02 <- rio::import_list("~/R/R Codes/Classification of HDLSS Data (Summer, 2021)/HDLSS-Summer-2021/TwoClass-PopularClassifiers-Simulated-JRC/Results/Pop-C01-vs-C02-with-nn.xlsx")
...
for (k in 1:length(d.seq)) {
   ...
   df.C01.vs.C02[[k]]$SVMRBF <- c(result, NA, mean(result), sciplot::se(result))
...
writexl::write_xlsx(x = df.C01.vs.C02,
                    path = "C:\\Users\\JYOTISHKA\\Desktop\\Pop-C01-vs-C02-updated.xlsx")
