...
df.N03.vs.t3 <- rio::import_list("~/R/R Codes/Classification of HDLSS Data (Summer, 2021)/HDLSS-Summer-2021/TwoClass-PopularClassifiers-Simulated-JRC/Results/Pop-N03-vs-t3-with-nn.xlsx")
...
for (k in 1:length(d.seq)) {
   ...
   df.N03.vs.t3[[k]]$SVMRBF <- c(result, NA, mean(result), sciplot::se(result))
...
writexl::write_xlsx(x = df.N03.vs.t3,
                    path = "C:\\Users\\JYOTISHKA\\Desktop\\Pop-N03-vs-t3-updated.xlsx")
